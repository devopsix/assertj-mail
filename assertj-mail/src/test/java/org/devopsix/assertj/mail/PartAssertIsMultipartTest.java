...
public class PartAssertIsMultipartTest {
  ...
  public void contentCannotBeExtracted() throws Exception {
    ...
    assertThrows(AssertionError.class, () -> MailAssertions.assertThat(part).isMultipart());
  }
  ...
  public void contentIsPresent() {
    ...
    MailAssertions.assertThat(outerPart).isMultipart();
  }

  @Test
  public void contentIsNotMultipart() {
    Part outerPart = newPart().text("Lorem ipsum").create();
    assertThrows(AssertionError.class, () -> MailAssertions.assertThat(outerPart).isMultipart());
  }
}
